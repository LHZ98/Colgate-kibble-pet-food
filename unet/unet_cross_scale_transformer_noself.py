...
class Unet_cross_scale_transformer_noself(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        super(Unet_cross_scale_transformer_noself, self).__init__()
