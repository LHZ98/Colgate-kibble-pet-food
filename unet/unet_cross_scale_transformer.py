...
class Unet_cross_scale_transformer(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        super(Unet_cross_scale_transformer, self).__init__()
    ...
    def forward(self, x):
        ...
        x5_self_atten = self.self_atten(x5)
        # print('x5_self_atten:',x5_self_atten.size())

        x5 = x5_spatial_atten+x5_self_atten
        # print('x5:',x5.size())
