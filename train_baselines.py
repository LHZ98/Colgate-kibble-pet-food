...
from othermodels import UNet,UNet_2Plus,UNet_3Plus,MANet,SwinUnet,UNetFormer, AttentionUNet, TransUNet
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch}/{epochs}', unit='img') as pbar:
            for batch in train_loader:
                ...
                with torch.autocast(device.type if device.type != 'mps' else 'cpu', enabled=amp):
                    ...
                    # print('pred shape:', masks_pred.shape)
...
def get_args():
    ...
    parser.add_argument('--model', '-m', type=str, default='UNet2Plus', help='Load model from a .pth file')
...
if __name__ == '__main__':
    ...
    if args.model == 'UNet':
        model = UNet(n_channels=1, n_classes=args.classes)
