...
class Decoder(nn.Module):
    def __init__(self, out_channels, n_classes):
        ...
        self.conv1 = nn.Conv2d(int(out_channels * 1 / 8), n_classes, kernel_size=1)
...
class TransUNet(nn.Module):
    def __init__(self, img_dim, n_classes, in_channels = 1, out_channels = 128, head_num = 4, mlp_dim = 512, block_num = 8, patch_dim = 16):
        super().__init__()
